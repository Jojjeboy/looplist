...
> I want a new colorful favicon that that represent a checkbox that is checked, also update the Page title to 'LoopList' and on a specific Category page, print 'LoopList - <category>' And on List page print out 'LoopList <List>'
...
> add following remote for the git repo: https://github.com/Jojjeboy/looplist.git
